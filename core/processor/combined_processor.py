...
JSON 结构要求（严格遵守）：
{
  ...
  "analysis": {
    "who": "涉及的主体（人/机构/国家），必须从原文提取。严禁推测。若原文确实未提及，填'暂无信息'",
    "what": "发生了什么事，必须从原文提取。严禁推测。若原文确实未提及，填'暂无信息'",
    "when": "时间信息，优先使用原文明确时间。严禁推测。若原文确实未提及，填'暂无信息'",
    "where": "地点信息，必须从原文提取。严禁推测。若原文确实未提及，填'暂无信息'",
    "why": "原因/背景，必须从原文提取。严禁推测。若原文确实未提及，填'暂无信息'",
    "how": "方式/过程/结果，必须从原文提取。严禁推测。若原文确实未提及，填'暂无信息'"
  },
...
## 5W1H 提取规则（重要）
1. 所有字段必须基于原文事实，严禁推测、猜测或推断
2. 无法从原文获取的字段，统一填"暂无信息"（禁止填"无"、"未知"、"不详"等）
3. 禁止输出推测性描述（如"可能是..."、"据推测..."、"似乎..."等）
